    ...
    <form id="form1" runat="server" class="form1">
          ...
          <div class="top">
            ...
            <div class="search">
               ...
               <div style="width:100%; height:30%; margin-top:10px; text-align:center"> <asp:TextBox ID="txt_user_search" runat="server" placeholder="başlık, #entry ya da @yazar" Width="250px" Height="20px" BorderStyle="Solid" ></asp:TextBox>
                <asp:Button ID="btn_user_search" runat="server" Width="70px" Height="25px" Text="ara" Font-Size="Large" BorderStyle="None"  OnClick="btn_user_search_Click"/></div>
               <div style="width:100%; height:49%"> <asp:Label ID="lbl_user_search" runat="server"></asp:Label></div>
            </div>
            <div class="profile">
                <div class="buttons">
