...
<body>
        ...
        <div class="top">
            <div class="logo">
               <a href="muhendis-sozluk"> <img src="/Pictures/mainlogo.png" style="width:100%; height:100%;"/></a>
            </div>
            ...
            <asp:Repeater ID="title_repeater" runat="server">
                <ItemTemplate>
                    <div style="width: 100%; height: 30px; border-bottom: 1px dashed gray; padding-top: 10px; float: left; background-color: #777777">
                        ...
                        <a href='<%#string.Format("{0}", MuhendisSozluk.Helper.SEOUrl(Eval("Name").ToString()))%>' style="color: #544343; text-decoration: none; padding-left: 5px;"><%#Eval("Name")%></a>
