    ...
    <form id="form1" runat="server">
        ...
        <div class="cover" style="width:80%; float:left;  margin-top:20px; background-color:#d9d9d9">
            <div class="entry" style="width:100%; height:auto; padding:5px">
                ...
                <asp:TextBox ID="txt_rpt_entry_content" runat="server" TextMode="MultiLine" Width="700px" BorderStyle="None" Visible="false"> </asp:TextBox>
                 <asp:Label ID="lbl_rpt_entry_content" runat="server" TextMode="MultiLine" Width="700px" BorderStyle="None" BackColor="#d9d9d9"  Text='<% #Eval("Contents") %>'></asp:Label>
